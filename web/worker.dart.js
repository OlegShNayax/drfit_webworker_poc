...
(function dartProgram() {
  ...
  A.ServerImplementation.prototype = {
    serve$1(channel) {
      ...
      t3 = channel.__GuaranteeChannel__streamController_F;
      t3 === $ && A.throwLateFieldNI("_streamController");
  ...
  A._StatementBasedTransactionExecutor.prototype = {
    ...
    beginTransaction$0() {
      ...
      t1 = "" + ownDepth;
      return new A._StatementBasedTransactionExecutor(_this._delegate, new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), _this, "SAVEPOINT s" + t1, "RELEASE s" + t1, "ROLLBACK TO s" + t1, _this._db, new A.Lock());
    },
    send$0(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
  ...
  (function installTearOffs() {
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 10, 0, 0);
    ...
    _instance_2_u(_, "get$_handleError", "_handleError$2", 45);
